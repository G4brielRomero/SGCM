...
export class CreateSpecialtyDto {
  @ApiProperty({ description: 'Nome único da especialidade', example: 'Cardiologia' })
  @IsNotEmpty()
  @IsString()
  name: string;

  @ApiProperty({ description: 'Descrição da especialidade', example: 'Especialidade voltada ao coração e sistema cardiovascular.' })
  @IsNotEmpty()
  @IsString()
  description: string;
}
...
export class SpecialtyResponseDto {
  ...
  @Expose()
  @ApiProperty({ example: 'Especialidade voltada ao coração e sistema cardiovascular.' })
  description: string;
